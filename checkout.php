...
if(isset($_POST['order_btn'])){
 ...
 /* puts all the product name and product qty as a associative array in product name*/
...
<div class="checkout-btn">
    <a 
        href="<?= $user_logged_in ? 'checkout.php' : 'javascript:void(0)' ?>" 
...
document.getElementById('checkout-btn').addEventListener('click', function (event) {
    ...
    <?php if (!$isLoggedIn): ?>
        ...
        window.location.href = '#signup-container'; // Redirect to signup section
    <?php endif; ?>
});
</script>
